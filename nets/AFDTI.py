...
from nets.darknet import DarkNet53_extractor, darknet53_extractor


class FUsion_net(nn.Module):
    def __init__(self, dropout_rate=0.3, kerel_num=32, feature_dim=512,use_attention=4):
        super().__init__()
        # Visual Def
    ...
    def forward(self, x, y):
        ...
        print(feature_tf.shape,fi_tem.shape)
        # Feature Fusion
